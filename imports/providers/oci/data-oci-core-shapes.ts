// https://www.terraform.io/docs/providers/oci/r/data_oci_core_shapes.html
...
export interface DataOciCoreShapesConfig extends TerraformMetaArguments {
  readonly availabilityDomain?: string;
  readonly compartmentId: string;
  readonly imageId?: string;
  /** filter block */
  readonly filter?: DataOciCoreShapesFilter[];
}
export class DataOciCoreShapesShapesMaxVnicAttachmentOptions extends ComplexComputedList {
...
export class DataOciCoreShapesShapesMemoryOptions extends ComplexComputedList {
...
export class DataOciCoreShapesShapesNetworkingBandwidthOptions extends ComplexComputedList {
...
export class DataOciCoreShapesShapesOcpuOptions extends ComplexComputedList {
...
export class DataOciCoreShapesShapes extends ComplexComputedList {
...
export class DataOciCoreShapes extends TerraformDataSource {
  ...
  public shapes(index: string) {
    return new DataOciCoreShapesShapes(this, 'shapes', index);
  }

  // filter - computed: false, optional: true, required: false
  private _filter?: DataOciCoreShapesFilter[];
  public get filter() {
    return this._filter;
  }
  public set filter(value: DataOciCoreShapesFilter[] | undefined) {
    this._filter = value;
  }
