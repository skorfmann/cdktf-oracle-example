// https://www.terraform.io/docs/providers/oci/r/data_oci_health_checks_ping_monitors.html
...
export interface DataOciHealthChecksPingMonitorsConfig extends TerraformMetaArguments {
  readonly compartmentId: string;
  readonly displayName?: string;
  readonly homeRegion?: string;
  /** filter block */
  readonly filter?: DataOciHealthChecksPingMonitorsFilter[];
}
export class DataOciHealthChecksPingMonitorsPingMonitors extends ComplexComputedList {
...
export class DataOciHealthChecksPingMonitors extends TerraformDataSource {
  ...
  // ping_monitors - computed: true, optional: false, required: true
  public pingMonitors(index: string) {
    return new DataOciHealthChecksPingMonitorsPingMonitors(this, 'ping_monitors', index);
  }

  // filter - computed: false, optional: true, required: false
  private _filter?: DataOciHealthChecksPingMonitorsFilter[];
  public get filter() {
    return this._filter;
  }
  public set filter(value: DataOciHealthChecksPingMonitorsFilter[] | undefined) {
    this._filter = value;
  }
