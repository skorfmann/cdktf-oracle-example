...
export interface IdentityDynamicGroupConfig extends TerraformMetaArguments {
...
export class IdentityDynamicGroup extends TerraformResource {
  ...
  private _timeouts?: IdentityDynamicGroupTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: IdentityDynamicGroupTimeouts | undefined) {
  ...
  public synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      matching_rule: this._matchingRule,
      name: this._name,
