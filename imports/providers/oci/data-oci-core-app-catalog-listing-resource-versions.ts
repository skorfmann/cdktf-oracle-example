// https://www.terraform.io/docs/providers/oci/r/data_oci_core_app_catalog_listing_resource_versions.html
...
export interface DataOciCoreAppCatalogListingResourceVersionsConfig extends TerraformMetaArguments {
  readonly listingId: string;
  /** filter block */
  readonly filter?: DataOciCoreAppCatalogListingResourceVersionsFilter[];
}
export class DataOciCoreAppCatalogListingResourceVersionsAppCatalogListingResourceVersions extends ComplexComputedList {
...
export class DataOciCoreAppCatalogListingResourceVersions extends TerraformDataSource {
  ...
  public appCatalogListingResourceVersions(index: string) {
    return new DataOciCoreAppCatalogListingResourceVersionsAppCatalogListingResourceVersions(this, 'app_catalog_listing_resource_versions', index);
  }
  ...
  private _filter?: DataOciCoreAppCatalogListingResourceVersionsFilter[];
  public get filter() {
    return this._filter;
  }
  public set filter(value: DataOciCoreAppCatalogListingResourceVersionsFilter[] | undefined) {
    this._filter = value;
  }
