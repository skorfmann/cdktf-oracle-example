// https://www.terraform.io/docs/providers/oci/r/data_oci_core_virtual_networks.html
...
export interface DataOciCoreVirtualNetworksConfig extends TerraformMetaArguments {
  readonly compartmentId: string;
  readonly displayName?: string;
  readonly state?: string;
  /** filter block */
  readonly filter?: DataOciCoreVirtualNetworksFilter[];
}
export class DataOciCoreVirtualNetworksVirtualNetworks extends ComplexComputedList {
...
export class DataOciCoreVirtualNetworks extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataOciCoreVirtualNetworksConfig) {
    super(scope, id, {
  ...
  public virtualNetworks(index: string) {
    return new DataOciCoreVirtualNetworksVirtualNetworks(this, 'virtual_networks', index);
  }

  // filter - computed: false, optional: true, required: false
  private _filter?: DataOciCoreVirtualNetworksFilter[];
  public get filter() {
    return this._filter;
  }
  public set filter(value: DataOciCoreVirtualNetworksFilter[] | undefined) {
    this._filter = value;
  }
