// https://www.terraform.io/docs/providers/oci/r/data_oci_load_balancers.html
...
export interface DataOciLoadBalancersConfig extends TerraformMetaArguments {
  readonly compartmentId: string;
  readonly detail?: string;
  readonly displayName?: string;
  readonly state?: string;
  /** filter block */
  readonly filter?: DataOciLoadBalancersFilter[];
}
export class DataOciLoadBalancersLoadBalancersIpAddressDetails extends ComplexComputedList {
...
export class DataOciLoadBalancersLoadBalancers extends ComplexComputedList {
...
export class DataOciLoadBalancers extends TerraformDataSource {
  ...
  public loadBalancers(index: string) {
    return new DataOciLoadBalancersLoadBalancers(this, 'load_balancers', index);
  }
  ...
  private _filter?: DataOciLoadBalancersFilter[];
  public get filter() {
    return this._filter;
  }
  public set filter(value: DataOciLoadBalancersFilter[] | undefined) {
    this._filter = value;
  }
