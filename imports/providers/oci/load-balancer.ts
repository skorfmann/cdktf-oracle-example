// https://www.terraform.io/docs/providers/oci/r/load_balancer.html
...
export interface LoadBalancerConfig extends TerraformMetaArguments {
...
export class LoadBalancerIpAddressDetails extends ComplexComputedList {
...
export class LoadBalancer extends TerraformResource {
  ...
  public ipAddressDetails(index: string) {
    return new LoadBalancerIpAddressDetails(this, 'ip_address_details', index);
  }
  ...
  public set timeouts(value: LoadBalancerTimeouts | undefined) {
