...
export interface CoreInternetGatewayConfig extends TerraformMetaArguments {
...
export class CoreInternetGateway extends TerraformResource {
  ...
  private _timeouts?: CoreInternetGatewayTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: CoreInternetGatewayTimeouts | undefined) {
