...
export interface IdentityGroupConfig extends TerraformMetaArguments {
...
export class IdentityGroup extends TerraformResource {
  ...
  private _timeouts?: IdentityGroupTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: IdentityGroupTimeouts | undefined) {
